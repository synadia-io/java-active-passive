...
public class Listener implements ErrorListener, ConnectionListener {
    ...
    private final Map<Events, Integer> connectionEventCounts;
    ...
    public Listener label(String label) {
        this.label = label;
        return this;
    }

    public Listener printExceptions() {
        this.printExceptions = true;
        return this;
    }

    public Listener verbose() {
        this.verbose = true;
        return this;
    }
    ...
    public int getConnectionEventCount(Events event) {
    ...
    private void report(String func, Object message) {
        ...
        System.out.println("[" + simpleTime() + l + " | " + func + "] " + message);
    }

    public static String connectionInfo(Connection conn) {
        return "C." + Integer.toHexString(conn.hashCode()).toUpperCase() + "-S." + conn.getServerInfo().getServerId();
    }
}
